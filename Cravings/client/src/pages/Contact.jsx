            ...
            >
              ...
              <div className="mb-10">
                <div className="space-y-4">
                  ...
                  />
                  <textarea name="message" id="message" placeholder="Write your message" value={formData.message} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 transition disabled:cursor-not-allowed disabled:bg-gray-300" disabled={isLoading} onChange={handleChange} required></textarea>
                 </div> 
              </div>
